        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 margin-bottom-50 margin-top-50">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="{{ URL::asset('uploads/menu/minuman/'. $data_menu->foto) }}"  alt="tampil" srcset="" 
                            style="
                                width: 100%;
                                height: 350px;
                        ...
                        <form action="{{ url('admin/menu/minuman/' . $data_menu->id_menu) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group">
                                <label>Satuan</label>
                                    <select name="satuan" class="form-control">
                                        ...
                                        <option value="Cup" @if ($data_menu->satuan == "Cup") {{ 'selected' }} @endif>Cup</option>
